...
real(r8)          :: ndrop_cldf_growth_threshold = 0.01_r8 ! cloud fraction increment threshold for considering cloud growth in ndrop.F90
...
subroutine phys_ctl_readnl(nlfile)
   ...
   call mpibcast(ndrop_cldf_growth_threshold,     1 , mpir8,   0, mpicom)
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, & 
                       ...
                       ,ndrop_cldf_growth_threshold_out &
...
!-----------------------------------------------------------------------
   ...
   real(r8),          intent(out), optional :: ndrop_cldf_growth_threshold_out       
   ...
   if ( present(ndrop_cldf_growth_threshold_out ) ) ndrop_cldf_growth_threshold_out = ndrop_cldf_growth_threshold      
